...
@property (assign) IBOutlet GBInfoCheckButton *turnOffScreenCaptureWindowShadow;
@property (assign) IBOutlet GBInfoCheckButton *turnOffMailAttachmentInlineViewing;
